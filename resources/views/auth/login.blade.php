<x-guest-layout>
    <!-- Session Status -->
    <x-auth-session-status class="mb-4 dark:bg-black bg-white" :status="session('status')" />
    ...
    <div class="w-full flex justify-center mx-2">
        ...
        viewBox="0 0 18 19" style="color: yellow;">
        ...
        <svg class="w-4 h-4 mr-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 8 19" style="color: lightblue;">
